  ...
  try {
    if (request.method === "GET") {
      ...
      const bets = results.map((bet) => ({
        ...
        // DB: player_name -> API: player (or check frontend needs)
...
// ../.wrangler/tmp/pages-RUryb6/functionsRoutes-0.20050327509318033.mjs
var routes = [
  {
    routePath: "/api/bets",
    mountPath: "/api",
...
// ../.wrangler/tmp/bundle-LwLaDF/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-LwLaDF/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.31593720524955915.mjs.map
